...
public class StreamStatus1 {
   ...
   */
  public StreamStatus1(StatusEnum status) {
    this.status = status;
  }

  public StreamStatus1 status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  */
  ...
  public StreamStatus1 subject(StreamStatusSubject subject) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    StreamStatus1 streamStatus1 = (StreamStatus1) o;
    return Objects.equals(this.status, streamStatus1.status) &&
        Objects.equals(this.subject, streamStatus1.subject);
  }
