...
public class AddSubjectParametersSubject extends Subject {
   ...
   */
  public AddSubjectParametersSubject(FormatEnum format, String uri, String url, String email, String iss, String sub, String jti, String id, String phoneNumber, String issuer, String assertionId, List<@Valid SimpleSubject> identifiers) {
    super(format, identifiers);
  }

  public AddSubjectParametersSubject format(FormatEnum format) {
