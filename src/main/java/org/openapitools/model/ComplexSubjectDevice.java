...
public class ComplexSubjectDevice extends SimpleSubject {
   ...
   */
  public ComplexSubjectDevice(FormatEnum format, String uri, String url, String email, String iss, String sub, String jti, String id, String phoneNumber, String issuer, String assertionId) {
    super(format, uri, url, email, iss, sub, jti, id, phoneNumber, issuer, assertionId);
  }

  public ComplexSubjectDevice format(FormatEnum format) {
