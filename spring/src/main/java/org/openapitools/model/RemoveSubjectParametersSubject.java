...
public class RemoveSubjectParametersSubject extends Subject {
   ...
   */
  public RemoveSubjectParametersSubject(FormatEnum format, String uri, String url, String email, String iss, String sub, String jti, String id, String phoneNumber, String issuer, String assertionId, List<@Valid SimpleSubject> identifiers) {
    super(format, identifiers);
  }

  public RemoveSubjectParametersSubject format(FormatEnum format) {
