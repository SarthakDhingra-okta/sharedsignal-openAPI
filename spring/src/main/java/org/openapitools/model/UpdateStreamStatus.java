...
public class UpdateStreamStatus {
   ...
   */
  public UpdateStreamStatus(StatusEnum status) {
    this.status = status;
  }
  ...
  */
  ...
  public UpdateStreamStatus status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  */
  ...
  public UpdateStreamStatus subject(StreamStatusSubject subject) {
