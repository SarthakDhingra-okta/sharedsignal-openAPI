...
@Validated
@Tag(name = "StreamManagement", description = "[Spec](https://openid.net/specs/openid-sse-framework-1_0.html#management)
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"aud\" : \"https://popular-app.com\", \"delivery\" : { \"method\" : \"https://schemas.openid.net/secevent/risc/delivery-method/poll\" }, \"events_supported\" : [ \"https://schemas.openid.net/secevent/caep/event-type/session-revoked\", \"https://schemas.openid.net/secevent/risc/event-type/credential-compromise\" ], \"iss\" : \"https://most-secure.com\", \"format\" : \"format\", \"events_delivered\" : [ \"https://schemas.openid.net/secevent/risc/event-type/credential-compromise\" ], \"events_requested\" : [ \"https://schemas.openid.net/secevent/risc/event-type/credential-compromise\" ], \"min_verification_interval\" : 0 }";
